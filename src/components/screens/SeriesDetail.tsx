    ...
    >
      ...
      >
        ...
        >
          ...
          <span>?êÌîº?åÎìú {s.totalEp}Í∞?/span>
        </div>
        ...
        >
          ?§Ïùå ??Î≥¥Í∏∞ ¬∑ EP{String(s.episodes[0].ep).padStart(2, '0')}
        </button>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 32 }}>
          ...
          {s.cast && s.cast.length > 0 && (
            <div style={{ fontSize: 13, color: 'var(--ink-40)' }}>
              <span style={{ color: 'var(--ink-60)', marginRight: 6 }}>Ï∂úÏó∞Ïß?</span>
              {s.cast.join(', ')}
            </div>
          )}
          ...
          {s.creator && (
            <div style={{ fontSize: 13, color: 'var(--ink-40)' }}>
              <span style={{ color: 'var(--ink-60)', marginRight: 6 }}>?¨Î¶¨?êÏù¥??</span>
              {s.creator}
            </div>
          )}
        </div>
        ...
        <div style={{ marginTop: 32 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {Array.from({ length: s.totalEp }, (_, i) => {
              ...
              const title = real?.title ?? 'Í≥µÍ∞ú ?àÏ†ï';
              const locked = !real;
              return (
                <div
                  key={epNum}
      ...
      >
        ...
        >
          <span style={{ fontSize: 11, color: 'var(--ink-60)', fontWeight: 500 }}>?§Ïùå ??Î≥¥Í∏∞</span>
        ...
        >
          <span style={{ fontSize: 11, opacity: 0.9, fontWeight: 500 }}>?ÑÏ≤¥ Í¥Ä??(?†Ïù∏)</span>
        ...
        >
          ...
          >
            ...
            <p style={{ margin: '0 0 20px', fontSize: 14, color: 'var(--ink-60)', lineHeight: 1.5 }}>
              ?¥Îãπ Í∏∞Îä•?Ä ?ÑÏû¨ Ï§ÄÎπ?Ï§ëÏûÖ?àÎã§.<br/>Ï°∞Í∏àÎß?Í∏∞Îã§?§Ï£º?∏Ïöî!
            </p>
            <button
